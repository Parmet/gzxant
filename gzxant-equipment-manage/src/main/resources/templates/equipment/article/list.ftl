			    		...
			    		<div class="row">
                            ...
                            <div class = "row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select id="type_input" name="search_like_samplingtype" class="select2 _search" style="width:100%;">
                                        <option value="">请选择</option>
		  								<#list samplingTypes as type>
	...
	function getColumns() {
	    var c = [
...

	        {
	            ...
	            align: 'center',
	            formatter: function (value, row, index) {
	            	var edit_btn = '<a class="btn btn-primary btn-sm" href="#" mce_href="#" title="we2编辑" onclick="updateStandard(\''
