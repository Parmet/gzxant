...
ORYX.CONFIG.BLANK_IMAGE = ORYX.CONFIG.LIBS_PATH + '/ext-2.0.2/resources/img/default/s.gif';
...
ORYX.Plugins.Edit = Clazz.extend({
    ...
    construct: function(facade){
        ...
        this.facade.offer({
         ...
         icon: ORYX.PATH + "img/page_copy.png",
		 keyCodes: [{
				metaKeys: [ORYX.CONFIG.META_KEY_META_CTRL],
				keyCode: 67,
				keyAction: ORYX.CONFIG.KEY_ACTION_DOWN
        ...
        this.facade.offer({
         ...
         icon: ORYX.PATH + "img/page_paste.png",
		 keyCodes: [{
				metaKeys: [ORYX.CONFIG.META_KEY_META_CTRL],
				keyCode: 86,
				keyAction: ORYX.CONFIG.KEY_ACTION_DOWN
...
ORYX.Plugins.View = {
	...
	construct: function(facade, ownPluginData) {
		...
		this.facade.offer({
			...
			'icon': ORYX.PATH + "img/magnifier_zoom_in.png",
		...
		this.facade.offer({
			...
			'functionality': this.zoom.bind(this, [1.0 - ORYX.CONFIG.ZOOM_OFFSET]),
			'group': ORYX.I18N.View.group,
			'icon': ORYX.PATH + "img/magnifier_zoom_out.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.View.group,
			'icon': ORYX.PATH + "img/zoom_standard.png",
			'cls' : 'icon-large',
...
ORYX.Plugins.Arrangement = ORYX.Plugins.AbstractPlugin.extend({
	...
	construct: function(facade) {
		...
		this.facade.offer({
			...
			'icon': ORYX.PATH + "img/shape_move_front.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupZ,
			'icon': ORYX.PATH + "img/shape_move_back.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupZ,
			'icon': ORYX.PATH + "img/shape_move_forwards.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupZ,
			'icon': ORYX.PATH + "img/shape_move_backwards.png",
		...
		this.facade.offer({
			...
			'icon': ORYX.PATH + "img/shape_align_bottom.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_top.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_left.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_right.png",
		...
		**/
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_middle.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_center.png",
		...
		this.facade.offer({
			...
			'group': ORYX.I18N.Arrangement.groupA,
			'icon': ORYX.PATH + "img/shape_align_size.png",
