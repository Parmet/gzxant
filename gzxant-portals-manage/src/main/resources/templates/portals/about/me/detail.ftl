    ...
    <div class="row">
        <div class="col-sm-12">
            <form class="form-horizontal form-bordered" id="gzxantForm">
            	<input type="hidden" name="id" value="${portalsAboutMe.id}" />

            <#if portalsAboutMe.aboutMeImg == null>
                <input type="hidden" name="aboutMeImg" value="/img/log9.png" />
            </#if>

                <div class="form-group">
                    <label class="col-sm-3 control-label">关于我们的标题<span class="required">*</span></label>
                    <div class="col-sm-3">
                    	<input type="text" class="form-control" name="aboutMeTitle" placeholder="请输入关于我们的标题"
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">关于我们的图片</label>
                    <div class="col-sm-3">
                        <div id="localImag" style="margin-left:15px;">
                            <div class="img_box" id="imgBox">
                                <img id="imgshowdiv" style="width: 60px" src="${rc.contextPath}${portalsAboutMe.aboutMeImg}"
                        ...
                        var logoDropzone = new Dropzone("div#logoDropzone", {
                            ...
                            init: function () {
                                ...
                                this.on('removedfile', function () {
                                    $("#photo").val("${portalsAboutMe.aboutMeImg}");
                                    $("#imgshowdiv").attr('src', "${portalsAboutMe.aboutMeImg}");
                                    layer.alert('删除成功');
                                });
