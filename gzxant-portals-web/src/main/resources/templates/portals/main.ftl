...
<head>
        ...
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/css/animate.css">
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/css/magnific-popup.css">
		<link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/css/form-elements.css">
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/css/style.css">
        <link rel="stylesheet" href="${rc.contextPath}/${rc.contextPath}/portals/css/media-queries.css">
        ...
        <link rel="shortcut icon" href="${rc.contextPath}/portals/ico/favicon.png">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="${rc.contextPath}/${rc.contextPath}/portals/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="${rc.contextPath}/${rc.contextPath}/portals/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="${rc.contextPath}/${rc.contextPath}/portals/ico/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="${rc.contextPath}/${rc.contextPath}/portals/ico/apple-touch-icon-57-precomposed.png">
    ...
    <body>
        ...
        </div><div class="copyrights">Collect from <a href="http://www.cssmoban.com/"  title="网站模板">网站模板</a></div>
	            ...
	            <div class="row">
	            	<div class="col-sm-6 block-1-left wow fadeInLeft">
	            		<div class="slider-1-box slider-1-our-process">
	            			<img class="slider-1-img-active" src="${rc.contextPath}/${rc.contextPath}/portals/img/process/2.jpg" alt="" data-at2x="${rc.contextPath}/portals/img/process/2.jpg">
	        ...
	        <div class="container">
	            <div class="row">
                    <div class="col-sm-7 footer-copyright">
                    	&copy; Riona Bootstrap More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>.
                    </div>
        ...
        <!--[if lt IE 10]>
            <script src="${rc.contextPath}/portals/js/placeholder.js"></script>
        <![endif]-->
