...
public class CodeGenerate {
	...
	// --------------变动参数区 start------------------------------------------
	/* === 表名 === */
	private static String[] tableNames = {"car_booking_vehicle"}; //, "shop_order_goods", "shop_order_pay"
	/* === 开发者 === */
	public static String author = "mojin";
	/* === 输出目标项目，为空则生成在当前项目中 === */
	...
	// --------------数据源配置区 start------------------------------------------
	public static String url = "jdbc:mysql://192.168.0.200:3306/gzxant_car_booking?useUnicode=true&characterEncoding=utf8&useSSL=false";
