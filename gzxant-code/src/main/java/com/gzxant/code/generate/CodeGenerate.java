...
public class CodeGenerate {
	...
	// --------------变动参数区 start------------------------------------------
	/* === 表名 === */
	private static String[] tableNames = {"equipment_shop_product"}; //, "shop_order_goods", "shop_order_pay"
	/* === 开发者 === */
	public static String author = "ycxiao";
	/* === 输出目标项目，为空则生成在当前项目中 === */
	public static String targetProject = "gzxant-equipment-webback";
	...
	// --------------数据源配置区 start------------------------------------------
	public static String url = "jdbc:mysql://192.168.0.200:3306/gzxant_equipment?useUnicode=true&characterEncoding=utf8&useSSL=false";
